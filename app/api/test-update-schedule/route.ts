...
/**
 * POST /api/test-update-schedule
 * Test API để kiểm tra chức năng update schedule
 */
export async function POST(request: NextRequest) {
  try {
    console.log('🧪 Testing update schedule functionality...');
    ...
    if (testType === 'validation') {
      ...
      return NextResponse.json({
        ...
        message: `Update validation tests completed: ${passedTests}/${totalTests} passed`
      });
