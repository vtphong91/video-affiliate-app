        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              ...
              <Link href="/blog">
                <Button variant="ghost">Tất cả Reviews</Button>
              </Link>
            </div>
          </nav>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><Link href="/blog" className="hover:text-white transition">Blog Reviews</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/" className="hover:text-white transition">Trang chủ</Link></li>
                <li><Link href="/blog" className="hover:text-white transition">Tất cả Reviews</Link></li>
                <li><Link href="/#categories" className="hover:text-white transition">Danh mục</Link></li>
              </ul>
            </div>
          </div>
