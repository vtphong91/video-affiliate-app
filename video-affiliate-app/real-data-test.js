// Test script để verify Real Data Integration
...
function testRealDataIntegration() {
  ...
  console.clear();
  console.log('🧹 Console cleared, starting real data test...');
...
// Export functions
window.realDataTests = {
  testRealDataIntegration,
  clearTestDataAndTest,
};

console.log('Real Data Integration test functions loaded!');
console.log('Available functions:');
console.log('- realDataTests.testRealDataIntegration() - Test real data integration');
console.log('- realDataTests.clearTestDataAndTest() - Clear test data and test real data');
