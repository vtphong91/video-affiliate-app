-- Phase 1: Basic Member Management Migration
-- Run this first to test the basic schema
...
-- 6. Update existing user to admin role (replace with your user ID)
UPDATE user_profiles 
SET role = 'admin', permissions = '["admin:all"]'
WHERE id = '1788ee95-7d22-4b0b-8e45-07ae2d03c7e1';
